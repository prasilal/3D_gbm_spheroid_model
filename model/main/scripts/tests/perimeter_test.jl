...
cfg = Dict(
    ...
    :rule_graph => @d(
        ...
        :resting_time => 5,
        :zg => @d(
            :gbm_p => [(:gbm_p, :adhesion, 300),(:gbm_p, :volume, 1000, 15), (:gbm_p, :perimeter, 5, 200), (:gbm_p, :prod_r, 0.01), (:gbm_p, :divide, 0.9)],
            :gbm_q => [(:gbm_q, :adhesion, 100),  (:gbm_q, :volume, 100, 13), (:gbm_q, :perimeter, 5, 200), (:gbm_q, :prod_r, 0.01), (:gbm_q, :divide, 0.5)],
            :gbm_n => [(:gbm_n, :adhesion, 100),  (:gbm_n, :volume, 50, 10),  (:gbm_n, :perimeter, 10, 120)],
    ...
    :cells => begin
        # Smaller cluster for perimeter testing
        spheroid_center = (15, 15, 15)
        spheroid_radius = 1  # smaller radius
...
simulate(sim_desc, record= false, num_of_steps = 100)
