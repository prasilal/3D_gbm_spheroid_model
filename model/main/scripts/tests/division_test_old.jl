...
cfg = Dict(
    ...
    :rule_graph => @d(
        ...
        :resting_time => 5,
        :zg => @d(
            :gbm_p => [(:gbm_p, :adhesion, 100), (:gbm_p, :volume, 100, 150), (:gbm_p, :perimeter, 100, 250), (:gbm_p, :prod_r, 0.01), (:gbm_p, :divide, 0.9)],
            :gbm_q => [(:gbm_q, :adhesion, 80),  (:gbm_q, :volume, 100, 130), (:gbm_q, :perimeter, 100, 220), (:gbm_q, :prod_r, 0.01), (:gbm_q, :divide, 0.5)],
...
simulate(sim_desc, record= false, num_of_steps = 20)
