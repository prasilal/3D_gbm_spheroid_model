    ...
    cfg = Dict(
        ...
        :rule_graph => @d(
            ...
            :zg => @d(
                ...
                :gbm_n => [(:gbm_n, :adhesion, 120),  (:gbm_n, :volume, 1000, 9),  (:gbm_n, :perimeter, 10, 130), (:gbm_n, :prod_r, 0.1)], #20
                ...
                :gsc_q => [(:gsc_q, :adhesion, 60), (:gsc_q, :volume, 1000, 9), (:gsc_q, :perimeter, 10, 125), (:gsc_q, :prod_r, 0.1)],
                ...
                :msc_anti => [(:msc_anti, :adhesion, 1000), (:msc_anti, :volume, 2000, 8), (:msc_anti, :perimeter, 10, 120), (:msc_anti, :prod_r, 0.1), (:ecm_gsc, :prod_v, 1.5), (:growth_signal, :prod_v, 1.5)],
        ...
        :reactions => [
            ...
            @d(:react => [(1, :oxygen), (1, :gbm_p)], :prod => [], :k => 100.0, :w => 1.0, :r_absorb => true),
            @d(:react => [(1, :glucose), (1, :gbm_p)], :prod => [], :k => 1.0, :w => 1.0, :r_absorb => true),
            ...
            @d(:react => [(1, :oxygen), (1, :gsc_p)], :prod => [], :k => 100.0, :w => 1.0, :r_absorb => true),
            @d(:react => [(1, :glucose), (1, :gsc_p)], :prod => [], :k => 1.0, :w => 1.0, :r_absorb => true),
            ...
            # MSC Before:
            @d(:react => [(1, :oxygen), (1, :msc_before)], :prod => [], :k => 0.1, :w => 1.0, :r_absorb => true),
            @d(:react => [(1, :glucose), (1, :msc_before)], :prod => [], :k => 0.0001, :w => 1.0, :r_absorb => true)
        ],

        :cell_state_update => @d(
            :transition_fn => modular_transition_dispatcher,
            :dont_absorb_vaxes_for_cell => absorb_vaxes_for_cell,
            :thresholds => @d(
                :hypoxia => 0.35,
                :severe_hypoxia => 0.05,
                :starvation => 0.2962,
            ...
            :transitions => @d(
                ...
                :gbm_q_to_n_prob => @d(:low => 0.55, :medium => 0.65, :high => 0.80),
