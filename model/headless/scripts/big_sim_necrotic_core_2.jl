...
function mk_cfg(args)
    ...
    cfg = Dict(
        ...
        :vaxes => @d(
            ...
            :gbm_p => @d(:d => 0.0, :D => 0.0, :rd => 0.0, :diffusion_multipliers => @d(:oxygen => 0.6, :glucose => 0.5), :interphase_duration => 10, :resting_period => 20), 
            ...
            :gsc_p => @d(:d => 0.0, :D => 0.0, :rd => 0.0, :diffusion_multipliers => @d(:oxygen => 0.6, :glucose => 0.5), :interphase_duration => 10, :resting_period => 30),
            :gsc_q => @d(:d => 0.0, :D => 0.0, :rd => 0.0, :diffusion_multipliers => @d(:oxygen => 0.5, :glucose => 0.4), :interphase_duration => 10, :resting_period => 30),
        ...
        :reactions => [
            ...
            @d(:react => [(1, :oxygen), (1, :gbm_p)], :prod => [], :k => 1000.0, :w => 1.0, :r_absorb => true),
            @d(:react => [(1, :glucose), (1, :gbm_p)], :prod => [], :k => 0.1, :w => 1.0, :r_absorb => true),
            ...
            @d(:react => [(1, :oxygen), (1, :gsc_p)], :prod => [], :k => 1000.0, :w => 1.0, :r_absorb => true),
            @d(:react => [(1, :glucose), (1, :gsc_p)], :prod => [], :k => 0.1, :w => 1.0, :r_absorb => true),
