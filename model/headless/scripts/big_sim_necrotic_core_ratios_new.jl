...
function mk_cfg(args)
    ...
    cfg = Dict(
        ...
        :rule_graph => @d(
            ...
            :resting_time => 30,
            :zg => @d(
                :gbm_p => [(:gbm_p, :adhesion, 15), (:gbm_p, :volume, 2000, 11), (:gbm_p, :perimeter, 10, 140), (:gbm_p, :prod_r, 0.1), (:lactate, :prod_v, 1.0)], #40
                ...
                :gsc_p => [(:gsc_p, :adhesion, 15), (:gsc_p, :volume, 2000, 10), (:gsc_p, :perimeter, 10, 125), (:gsc_p, :prod_r, 0.1), (:lactate, :prod_v, 1.0)],
