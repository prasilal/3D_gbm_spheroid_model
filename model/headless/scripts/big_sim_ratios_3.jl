...
function mk_cfg(args)
    ...
    cfg = Dict(
        ...
        :reactions => [
            ...
            @d(:react => [(1, :oxygen), (1, :gbm_p)], :prod => [], :k => 10.0, :w => 1.0, :r_absorb => true),
            @d(:react => [(1, :glucose), (1, :gbm_p)], :prod => [], :k => 0.02, :w => 1.0, :r_absorb => true),
            ...
            @d(:react => [(1, :oxygen), (1, :gsc_p)], :prod => [], :k => 10.0, :w => 1.0, :r_absorb => true),
            @d(:react => [(1, :glucose), (1, :gsc_p)], :prod => [], :k => 0.02, :w => 1.0, :r_absorb => true),
