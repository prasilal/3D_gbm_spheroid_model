    ...
    cfg = Dict(
        ...
        :rule_graph => @d(
            ...
            :zg => @d(
                ...
                :gbm_q => [(:gbm_q, :adhesion, 100),  (:gbm_q, :volume, 1000, 10), (:gbm_q, :perimeter, 10, 130), (:gbm_q, :prod_r, 0.1)], #35
                ...
                :msc_p => [(:msc_p, :adhesion, 1000), (:msc_p, :volume, 2000, 8), (:msc_p, :perimeter, 10, 120), (:msc_p, :prod_r, 0.1),  (:ecm_barrier, :prod_v, 1.5)],
                :msc_anti => [(:msc_anti, :adhesion, 1000), (:msc_anti, :volume, 2000, 8), (:msc_anti, :perimeter, 10, 120), (:msc_anti, :prod_r, 0.1), (:ecm_barrier, :prod_v, 1.5)],
