    ...
    cfg = Dict(
        ...
        :vaxes => @d(
            :glucose => @d(
                ...
                :d => 0.0,      
                :rd => 0.0,      
                :init => (2:GRID_SIZE-1, 2:GRID_SIZE-1, 2:GRID_SIZE-1, 3.2074),
                :show => false    
            ),
            :oxygen => @d(
                :D => 0.16666,       
                :d => 0.0,      
                :rd => 0.0,      
                :init => (2:GRID_SIZE-1, 2:GRID_SIZE-1, 2:GRID_SIZE-1, 4.4),
                :show => false    
            ),
            :lactate => @d(
                :D => 0.005,       
            ...
            :msc_p => @d(:d => 0.0, :D => 0.0, :rd => 0.0, :diffusion_multipliers => @d(:oxygen => 0.7, :glucose => 0.5), :interphase_duration => 15, :resting_period => 15), 
            :msc_anti => @d(:d => 0.0, :D => 0.0, :rd => 0.0, :diffusion_multipliers => @d(:oxygen => 0.5, :glucose => 0.4), :interphase_duration => 20, :resting_period => 15),
        ...
        :rule_graph => @d(
            ...
            :resting_time => 30,
            :zg => @d(
                :gbm_p => [(:gbm_p, :adhesion, 100), (:gbm_p, :volume, 2000, 11), (:gbm_p, :perimeter, 10, 140), (:gbm_p, :prod_r, 0.1), (:lactate, :prod_v, 1.0), (:gbm_p, :divide, 0.9)], #40
                ...
                :gsc_p => [(:gsc_p, :adhesion, 80), (:gsc_p, :volume, 2000, 10), (:gsc_p, :perimeter, 10, 125), (:gsc_p, :prod_r, 0.1), (:lactate, :prod_v, 1.0), (:gsc_p, :divide, 0.95)],
                :gsc_q => [(:gsc_q, :adhesion, 60), (:gsc_q, :volume, 1000, 10), (:gsc_q, :perimeter, 10, 125), (:gsc_q, :prod_r, 0.1)],

                :msc_p => [(:msc_p, :adhesion, 600), (:msc_p, :volume, 2000, 10), (:msc_p, :perimeter, 10, 120), (:msc_p, :prod_r, 0.1), (:ecm_gsc, :prod_v, 1.5), (:growth_signal, :prod_v, 1.5), (:msc_p, :divide, 0.0)],
                :msc_anti => [(:msc_anti, :adhesion, 600), (:msc_anti, :volume, 1000, 25), (:msc_anti, :perimeter, 10, 320), (:msc_anti, :prod_r, 0.1), (:ecm_barrier, :prod_v, 1.0), (:msc_p, :divide, 0.25)],
                :msc_before => [(:msc_before, :adhesion, 600), (:msc_before, :volume, 1000, 20), (:msc_before, :perimeter, 10, 300), (:msc_before, :prod_r, 0.1), (:ecm_barrier, :prod_v, 1.0), (:msc_p, :divide, 0.0)],
