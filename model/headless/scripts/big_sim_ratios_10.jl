...
function mk_cfg(args)
    ...
    cfg = Dict(
        ...
        :rule_graph => @d(
            ...
            :resting_time => 30,
            :zg => @d(
                :gbm_p => [(:gbm_p, :adhesion, 15), (:gbm_p, :volume, 2000, 11), (:gbm_p, :perimeter, 10, 140), (:gbm_p, :prod_r, 0.1), (:lactate, :prod_v, 1.0), (:gbm_p, :divide, 0.7)], #40
                :gbm_q => [(:gbm_q, :adhesion, 15),  (:gbm_q, :volume, 1000, 10), (:gbm_q, :perimeter, 10, 130), (:gbm_q, :prod_r, 0.1)], #35
                :gbm_n => [(:gbm_n, :adhesion, 10),  (:gbm_n, :volume, 1000, 9),  (:gbm_n, :perimeter, 10, 130), (:gbm_n, :prod_r, 0.1)], #20

                :gsc_p => [(:gsc_p, :adhesion, 15), (:gsc_p, :volume, 2000, 10), (:gsc_p, :perimeter, 10, 125), (:gsc_p, :prod_r, 0.1), (:lactate, :prod_v, 1.0), (:gsc_p, :divide, 0.75)],
                :gsc_q => [(:gsc_q, :adhesion, 15), (:gsc_q, :volume, 1000, 9), (:gsc_q, :perimeter, 10, 125), (:gsc_q, :prod_r, 0.1)],

                :msc_p => [(:msc_p, :adhesion, 5), (:msc_p, :volume, 2000, 10), (:msc_p, :perimeter, 10, 120), (:msc_p, :prod_r, 0.1), (:ecm_gsc, :prod_v, 1.5), (:growth_signal, :prod_v, 1.5)],
                :msc_anti => [(:msc_anti, :adhesion, 5), (:msc_anti, :volume, 2000, 8), (:msc_anti, :perimeter, 10, 120), (:msc_anti, :prod_r, 0.1), (:ecm_gsc, :prod_v, 1.5), (:growth_signal, :prod_v, 1.5)],
                :msc_before => [(:msc_before, :adhesion, 10), (:msc_before, :volume, 1000, 15), (:msc_before, :perimeter, 10, 230), (:msc_before, :prod_r, 0.1)],
