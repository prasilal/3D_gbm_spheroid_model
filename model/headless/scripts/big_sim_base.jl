    ...
    cfg = Dict(
        ...
        :rule_graph => @d(
            ...
            :zg => @d(
                ...
                :msc_p => [(:msc_p, :adhesion, 500), (:msc_p, :volume, 1000,25), (:msc_p, :perimeter, 10, 320), (:msc_p, :prod_r, 0.1), (:ecm_gsc, :prod_v, 1.0), (:growth_signal, :prod_v, 1.0), (:msc_p, :divide, 0.4)],
        ...
        :cells => begin
            ...
            for (ctype, count) in counts
                for _ in 1:count
                    ...
                    cum_state = ctype == :msc ? :msc_anti : Symbol(string(ctype), "_p")
                    push!(cells, @d(
