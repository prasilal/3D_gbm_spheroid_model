...
function mk_cfg(args)
    ...
    cfg = Dict(
        ...
        :reactions => [
            ...
            @d(:react => [(1, :glucose), (1, :gbm_p)], :prod => [], :k => 0.01, :w => 1.0, :r_absorb => true),
            # GBM Quiescent: reduced uptake
            @d(:react => [(1, :oxygen), (1, :gbm_q)], :prod => [], :k => 0.5, :w => 1.0, :r_absorb => true),
            @d(:react => [(1, :glucose), (1, :gbm_q)], :prod => [], :k => 0.005, :w => 1.0, :r_absorb => true),
            ...
            @d(:react => [(1, :glucose), (1, :gsc_p)], :prod => [], :k => 0.01, :w => 1.0, :r_absorb => true),
            # GSC Quiescent: reduced uptake 
            @d(:react => [(1, :oxygen), (1, :gsc_q)], :prod => [], :k => 0.5, :w => 1.0, :r_absorb => true),
            @d(:react => [(1, :glucose), (1, :gsc_q)], :prod => [], :k => 0.005, :w => 1.0, :r_absorb => true),
