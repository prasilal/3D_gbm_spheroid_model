    ...
    cfg = Dict(
        ...
        :rule_graph => @d(
            ...
            :zg => @d(
                ...
                :msc_anti => [(:msc_anti, :adhesion, 600), (:msc_anti, :volume, 1000, 10), (:msc_anti, :perimeter, 10, 120), (:msc_anti, :prod_r, 0.1), (:ecm_gsc, :prod_v, 1.5), (:msc_p, :divide, 0.0)],
                :msc_before => [(:msc_before, :adhesion, 800), (:msc_before, :volume, 1000, 20), (:msc_before, :perimeter, 10, 300), (:msc_before, :prod_r, 0.1), (:ecm_barrier, :prod_v, 1.0), (:msc_p, :divide, 0.0)],
