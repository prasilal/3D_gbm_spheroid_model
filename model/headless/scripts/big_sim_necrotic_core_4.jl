...
function mk_cfg(args)
    ...
    cfg = Dict(
        ...
        :vaxes => @d(
            ...
            :gbm_p => @d(:d => 0.0, :D => 0.0, :rd => 0.0, :diffusion_multipliers => @d(:oxygen => 0.9, :glucose => 0.9), :interphase_duration => 10, :resting_period => 20), 
            :gbm_q => @d(:d => 0.0, :D => 0.0, :rd => 0.0, :diffusion_multipliers => @d(:oxygen => 0.8, :glucose => 0.8), :interphase_duration => 15, :resting_period => 20),  
            :gbm_n => @d(:d => 0.0, :D => 0.0, :rd => 0.0, :diffusion_multipliers => @d(:oxygen => 0.2, :glucose => 0.1)),

            :gsc_p => @d(:d => 0.0, :D => 0.0, :rd => 0.0, :diffusion_multipliers => @d(:oxygen => 0.9, :glucose => 0.9), :interphase_duration => 10, :resting_period => 30),
            :gsc_q => @d(:d => 0.0, :D => 0.0, :rd => 0.0, :diffusion_multipliers => @d(:oxygen => 0.8, :glucose => 0.8), :interphase_duration => 10, :resting_period => 30),
        ...
        :rule_graph => @d(
            ...
            :resting_time => 30,
            :zg => @d(
                :gbm_p => [(:gbm_p, :adhesion, 100), (:gbm_p, :volume, 2000, 11), (:gbm_p, :perimeter, 10, 140), (:gbm_p, :prod_r, 0.1), (:lactate, :prod_v, 1.0)], #40
                ...
                :gsc_p => [(:gsc_p, :adhesion, 80), (:gsc_p, :volume, 2000, 10), (:gsc_p, :perimeter, 10, 125), (:gsc_p, :prod_r, 0.1), (:lactate, :prod_v, 1.0)],
